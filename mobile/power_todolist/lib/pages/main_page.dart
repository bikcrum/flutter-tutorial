    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.transparent,
          elevation: 0,
          title: Text(MyLocalizations.of(context).appName),
          leading: FlatButton(
            child: MenuIconWidget(globalModel.logic.getWhiteInDark()),
            onPressed: () {
        ...
        floatingActionButton: AnimatedFloatingButtonWidget(
        ...
        body: Container(
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                Container(
                  margin: EdgeInsets.fromLTRB(68, 8, 50, 0),
                  child: InkWell(
                        ...
                        children: <Widget>[
                          Flexible(
                            child: InkWell(
                              ...
                              child: Text(
                                "${MyLocalizations.of(context).welcomeWord}${model.currentUserName}",
                                style: TextStyle(
                                  fontSize: 30,
                                  color: globalModel.logic.getWhiteInDark(),
                                ),
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      "${MyLocalizations.of(context).taskItems(model.tasks.length)}",
                      style: TextStyle(
                        fontSize: 15,
                        color: globalModel.logic.getWhiteInDark(),
                      ),
