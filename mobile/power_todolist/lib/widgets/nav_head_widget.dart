...
class NavHeadWidget extends StatefulWidget {
  @override
  _NavHeadWidgetState createState() => _NavHeadWidgetState();
}

class _NavHeadWidgetState extends State<NavHeadWidget> with SingleTickerProviderStateMixin {
      ...
      child: Stack(
        children: <Widget>[
          ...
          Positioned(
            ...
            left: circleOneRadius + circleTwoRadius + circleThreeRadius + circleFourRadius + circleFiveRadius,
  ...
  BoxDecoration getDecoration(BuildContext context, double circleOneRadius) {
    return BoxDecoration(shape: BoxShape.circle, gradient: LinearGradient(colors: getRandomColor(context)), boxShadow: [
