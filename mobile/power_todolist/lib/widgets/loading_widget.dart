...
class LoadingWidget extends StatelessWidget {
  ...
  LoadingWidget({this.progressColor, this.textColor, this.textSize, this.loadingText, this.flag = LoadingFlag.loading, this.errorCallBack, this.emptyText, this.errorText, this.size = 100, this.successWidget, this.idleText});
            ...
            children: <Widget>[
              Container(
                ...
                child: CircularProgressIndicator(
                  strokeWidth: size / 10,
                  valueColor: AlwaysStoppedAnimation(progressColor ?? primaryColor),
                ),
              ),
              SizedBox(
                height: size / 5,
              ...
              Text(
                loadingText ?? MyLocalizations.of(context).loading,
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              FlatButton(
                  ...
                  child: Text(
                    "${errorText ?? ""}".isEmpty ? MyLocalizations.of(context).reLoading : errorText,
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: textSize ?? size / 5, color: textColor ?? primaryColor),
                  )),
            ],
        ...
        return Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                emptyText ?? MyLocalizations.of(context).loadingEmpty,
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: textSize ?? size / 5, color: textColor ?? primaryColor),
              ),
            ],
        ...
        return Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                idleText ?? MyLocalizations.of(context).loadingIdle,
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: textSize ?? size / 5, color: textColor ?? primaryColor),
              )
            ],
